(() => {
  ...
  async function view(){
    ...
    if(qs.has('preview')){document.body.classList.add('is-preview');document.querySelector('#preview-channel').textContent=`TWITCH #${s.channel||'your_channel'}`;msg('Mika','Great stream! Thanks for today.',{subscriber:'1',badges:'subscriber/1'});return;}

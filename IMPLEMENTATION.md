...
公開サイトはチャット／枠／アラート／テロップ／まとめの5画面。チャットプレビューは従来幅440px設計、他は1920×1080。旧資料の本番URLはsparkle-chat-gamma.vercel.appで、今回のnecocreamドメインと異なるため、gugu219/sparkle-chatを正しいデプロイ先と断定していません。
